...
```
Error: locator.fill: Error: strict mode violation: locator('.oxd-input') resolved to 4 elements:
    1) <input data-v-1f99f73c="" data-v-636d6b87="" placeholder="Search" class="oxd-input oxd-input--active"/> aka getByRole('textbox', { name: 'Search' })
    2) <input data-v-1f99f73c="" autocomplete="off" class="oxd-input oxd-input--active"/> aka getByRole('textbox').nth(2)
    3) <input type="password" data-v-1f99f73c="" autocomplete="off" class="oxd-input oxd-input--active"/> aka getByRole('textbox').nth(3)
    4) <input type="password" data-v-1f99f73c="" autocomplete="off" class="oxd-input oxd-input--active"/> aka getByRole('textbox').nth(4)

Call log:
  - waiting for locator('.oxd-input')
        ...
        - list [ref=e123]:
          - listitem [ref=e124]:
            - generic [ref=e125] [cursor=pointer]:
              ...
              - paragraph [ref=e127]: Deepti Dasari
              - generic [ref=e128]: 
...
```ts
  ...
  19 |         this.userName = page.locator('.oxd-input');
