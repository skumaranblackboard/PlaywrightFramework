...
Call log:
  - waiting for locator('.oxd-input-group').filter({ hasText: 'Username' })
    - locator resolved to <div data-v-957b4417="" class="oxd-input-group oxd-input-field-bottom-space">…</div>
    - fill("Senth")
        ...
        - list [ref=e123]:
          - listitem [ref=e124]:
            - generic [ref=e125] [cursor=pointer]:
              ...
              - paragraph [ref=e127]: Sravya Dasari
              - generic [ref=e128]: 
...
```ts
  ...
  19 |         this.userName = page.locator('.oxd-input-group').filter({hasText: 'Username'});
