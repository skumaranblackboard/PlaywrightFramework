...
Call log:
  - waiting for locator('.oxd-select-wrapper').filter({ hasText: 'User Role' })
        ...
        - list [ref=e123]:
          - listitem [ref=e124]:
            - generic [ref=e125] [cursor=pointer]:
              ...
              - paragraph [ref=e127]: Pinakee Pattanaik
              - generic [ref=e128]: 
...
```ts
  ...
  13 |         this.userRole = page.locator('.oxd-select-wrapper').filter({hasText: 'User Role'});
...
> 22 |         await this.userRole.click();
     |                             ^ Error: locator.click: Test timeout of 30000ms exceeded.
  23 |         await this.page.getByText(UserRole, {exact: true}).click();
  24 |     } 
  25 | 
  26 | }
```